  ...
  const handleMouseMove = (e: React.MouseEvent) => {
    ...
    if ((isDraggingLeft || isDraggingRight) && rulerRef.current) {
      ...
      if (container) {
        ...
        if (isDraggingLeft) {
          const maxLeftPosition = PAGE_WIDTH - rightMargin - Minimum_space; // Prevent overlap
          ...
          const maxRightPosition = PAGE_WIDTH - leftMargin - Minimum_space; // Prevent overlap
          const newRightPosition = Math.max(0, Math.min(PAGE_WIDTH - rawPosition, maxRightPosition));
